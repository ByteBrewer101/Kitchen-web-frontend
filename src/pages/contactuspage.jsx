  ...
  return (
    <div>
      ...
      <div className="flex flex-col space-y-10 mt-10">
        <div
          className="h-[700px] w-full flex items-center justify-start bg-cover bg-center p-10 md:p-20"
          style={{ backgroundImage: `url(${map})` }}
        >
          <div className="flex flex-col space-y-4 bg-orange-50 rounded-xl p-6 md:p-10">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
              Find food lounge
            </h1>
            <h1 className="text-md md:text-xl w-full md:w-1/2">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <h1 className="font-semibold text-md w-full md:w-1/2">
        ...
        <div className="mx-6 md:mx-40">
          <div className="flex flex-col items-center justify-center w-full bg-orange-100 p-6 md:p-10 space-y-6 rounded-xl">
            ...
            <button className="text-white bg-orange-500 text-xl p-4 rounded-full w-fit px-10 md:px-20">
              Send
            </button>
          </div>
        </div>
