...
export function TopBar() {
  ...
  return (
    <div className="px-[20px] lg:px-[142px] py-[20px] lg:py-[30px]">
      <div className="flex justify-between items-center">
        ...
        {/* Desktop Menu */}
        <div className="hidden lg:flex justify-between w-1/3 text-[16px] font-[500] text-gray-500">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden mt-4 flex flex-col space-y-4 text-[16px] font-[500] text-gray-500">
          <button onClick={handleHomeClick}>Home</button>
          <button onClick={handleContactClick}>About Us</button>
          <button onClick={handleMenuClick}>Menu</button>
          <button onClick={handleContactClick}>Contact</button>
