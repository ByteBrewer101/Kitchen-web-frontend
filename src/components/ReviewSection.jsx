...
export function ReviewSection(){
    return (
      <div className="h-fit  flex justify-around">
        ...
        <div className="flex flex-col s  justify-center space-y-4  w-1/3">
          <h1 className="text-orange-500 font-semibold ">WHAT THEY SAY</h1>
          <h1 className="text-gray-800 text-5xl mb-4 font-extrabold">
            What Our Customers Say About Us
          </h1>
          <p className="text-gray-800 w-[300px] font-semibold text-lg">
            “Mausis Delicaciesis the best. Besides the many and delicious meals,
            the service is also very good, especially in the very fast delivey.
            I highly recommend Mausis Delicacies to you”.
          </p>
          ...
          <div className="flex items-center  ">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="size-6  stroke-yellow-500 fill-yellow-500 "
            >
              <path
                strokeLinecap="round"
